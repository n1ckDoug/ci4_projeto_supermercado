...
<div class="content-box">
    <?= form_open_multipart('/gerenciador/produtos/new_submit', ['novalidate' => true]) ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-12 px-5 pt-5">
            ...
            <div class="text-center">
                <img src="<?=base_url('assets/gerenciador/images/products/no_image.png') ?>" class="product-image img-fluid" id="product_image">
            </div>
